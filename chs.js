...
var cnItems = {
    ...
    'Boosting spores: 5.52e3%. Nerfing neighbor berries and flowers': '促进孢子:5.52 e3%。削弱邻居的浆果和花朵',
    'Tip: flowers next to mushrooms give them a large boost.': '小贴士:蘑菇旁边的花朵会给它们带来很大的帮助。',
    ...
    'nettle. Boosts neighbor mushroom spores production without increasing seed consumption. However, negatively affects neighboring berries and flowers, so avoid touching those with this plant. Crop type: nettle': '荨麻。在不增加种子消耗的情况下促进相邻蘑菇孢子的生产。然而，它会对邻近的浆果和花朵产生负面影响，所以要避免接触这种植物。作物类型:荨麻',
...
var cnRegReplace = new Map([
    ...
    [/^\+(.+)\% bonus to mushroom spores production, without increasing consumption$/, '蘑菇生产孢子奖金 \+$1\％，而不增加消耗'],
