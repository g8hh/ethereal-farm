...
var cnItems = {
    ...
    "plant a watercress (does not affect last planted type for shift key).": "种植一个豆瓣菜(不影响最后种植类型的shift键)。",
    ...
    "OR: Ctrl+click empty field to plant watercress": "或：Ctrl+单击空白田地种植豆瓣菜",
    ...
    " brassica": " 芸苔",
    "25% watercress base production (additive), +20%  lifespan duration": "25% 豆瓣菜基础生产（附加），+20% 寿命持续时间",
    "available: \"Upgrade watercress\": +25% watercress base production (additive), +20%  lifespan duration": "可用：\“升级豆瓣菜\”： +25％的豆瓣菜基础生产（附加）， +20％的寿命持续时间",
    "": "",
    "": "",
    "": "",
    "": "",
...
var cnRegReplace = new Map([
    ...
    [/^Goal: Plant up to 10 watercress on the field to reveal a next upgrade \((.+) planted\).$/, '目标：在田里种植多达10棵豆瓣菜，以揭示下一次升级（$1 已种植）。'],
