...
var cnItems = {
    ...
    "delete crop.": "删除作物。",
    "farm is an incremental game taking place on a field with a mysterious tree in the center. Most crops are permanent and there's no harvesting/selling/withering as in many farm games, instead it's about growing better and better plant types, with various neighbor-interaction rules with other plants in the field.": "农场是一个增量游戏，发生在中心有一棵神秘树的场地上。 大多数农作物都是永久性的，没有像许多农场游戏一样收获/销售/枯萎，而是要生长越来越更好的植物类型，以及与该领域其他植物的各种邻居交往规则。",
    ...
    "Unlocks multiplicity of bees. Requires that regular multiplicity for berries and mushrooms has been unlocked. Presence of multiple bees anywhere in the field will give a global bee bonus. The bonus per bee is 10": "解锁蜜蜂的多样性。 要求浆果和蘑菇的常规多样性已解锁。 在该领域的任何地方存在多只蜜蜂将给予全球蜜蜂奖励。 每只蜜蜂的奖金是 10",
    ...
    "Neighbor bonus in ethereal field: initial": "空灵领域的邻居奖励：初始",
    "Neighbor boost in the ethereal field: the automaton in the ethereal field gives an independent boost to neighbors, similar to lotuses.": "空灵领域的邻居提升：空灵领域的自动机给邻居一个独立的提升，类似于莲花。",
    ...
    "Buttons to delete all crops in the main field or in the ethereal field: these are in the automaton tab and are for convenience. Deleting the ethereal field still uses tokens as usual.": "删除主领域或空灵领域中所有作物的按钮：这些位于自动机选项卡中，为方便起见。删除 空灵 田地仍照常使用令牌。",
    "with blueprint": "和蓝图",
    "": "",
    "": "",
    "": "",
