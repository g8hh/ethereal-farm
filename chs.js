...
var cnItems = {
    ...
    "tier up: replace crop or template under mouse cursor with highest available tier of the same type that you can afford (no mouse click required": "层级提升：在鼠标光标下更换裁剪或模板，其最高可用类型的最高级别（无需单击鼠标需要单击）",
    ...
    "delete crop under mouse cursor (no mouse click required": "删除鼠标光标下的裁剪（无需鼠标点击",
    "delete crop.": "删除作物。",
    ...
    "go to the basic field tab": "转到基本字段选项卡",
    "go to the ethereal field tab (if available": "转到空灵字段选项卡（如果可用",
    "here": "这里",
