...
var cnItems = {
    ...
    'Thanks to spores, the tree completely rejuvenated and is now a young sprout, level 1. More spores will level up the tree more. The tree can unlock abilities and more at higher levels. Click the tree in the field for more info.': '多亏了孢子，这棵树才完全恢复了活力，现在是一个年轻的新芽，等级1。更多的孢子会使树的水平更高。 该树可以在更高级别上解锁能力以及更多功能。 单击田地中的树以获取更多信息。',
    ...
    "TIP: to get back to original strength over the next days, try to get the first new squirrel upgrades. To get those, push to high level berries and mushrooms, then focus on spore production to afford better nuts crops.": "提示：要在接下来的几天恢复原始强度，请尝试获得第一个新松鼠升级。为了获得这些，推高水平的浆果和蘑菇，然后专注于孢子生产以提供更好的坚果作物。",
    ...
    "Reward gotten: Unlocks the thistle crop, which is the next tier of nettles. Once unlocked, it's available in the base game once you have grown a portobello.": "获得的奖励：解锁蓟作物，这是荨麻的下一层。解锁后，一旦您种植了波托贝罗，它就可以在基础游戏中使用。",
    ...
    "Only blackberries, champignons, anemones, nettle, bee nests, watercress and mistletoe are available, from the beginning": "从一开始就只提供黑莓、香菇、海葵、荨麻、蜂巢、豆瓣和槲寄生",
    "Override field": "覆盖田地",
    ...
    "having grown a portobello": "长出了波多贝罗",
...
var cnPrefix = {
    ...
    "Thistle level ": "蓟等级 ",
    "stinging (tier ": "蛰（层 ",
    "Quadrillion seeds: have over 1Qa (1e15)": "万亿种子：拥有超过 1Qa (1e15)",
    "Quintillion seeds: have over 1Qi (1e18)": "Quintillion 种子：超过 1Qi (1e18)",
    "Thousand seeds: have over 1K (1e3)": "千粒种子：拥有超过 1K (1e3)",
    "Trillion seeds: have over 1T (1e12)": "万亿种子：拥有超过 1T (1e12)",
    "Million seeds: have over 1M (1e6)": "百万种子：拥有超过 1M (1e6)",
    "Billion seeds: have over 1B (1e9)": "十亿种子：拥有超过 1B (1e9)",
