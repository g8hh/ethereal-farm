...
var cnItems = {
    ...
    'breakdown of multipliers and bonuses and other detailed stats.': '乘数，奖金和其他详细统计信息的细目。',
    ...
    'boosts the bonus effect of ethereal neighbors of type berry, mushroom and flower by 50%. No effect if no appropriate neighbors. This crop boosts neighboring plants in the ethereal field, rather than boosting the basic field directly.': '使浆果，蘑菇和花朵类型的灵巧邻居的奖励效果提高50％。 如果没有适当的邻居，则没有效果。 这种作物可以促进空灵领域的邻近植物，而不是直接促进基础领域。',
    'boosts the boosting effect of flowers in the basic field by 25% (additive). No effect on ethereal neighbors here, but on the basic field instead.': '将基本领域中的花朵增强效果提高25％（添加）。 这里对空灵的邻居没有影响，但是对基本领域有影响。',
    ...
    'start': '开始',
    'transcend': '超越',
    'Transcend and start a challenge': '超越并开始一个挑战',
    'Challenges': '挑战',
    'Adult tree': '成年树',
    'Bee challenge': '蜜蜂挑战',
    'Challenge': '挑战',
    ...
    '. Base production: 235Qa seeds/s. Crop type:': '。基础产量:235Qa种子/秒。作物类型:',
    ...
    'Worker bees boost the global ecosystem: berries, mushrooms and flowers (so effectively cubic scaling). No neighboring require for this.': '工蜂促进了全球生态系统:浆果，蘑菇和花朵(所以有效的立方尺度)。没有相邻的要求。',
    ...
    'beehives available in the regular game from now on after planting daisies. In the main game, beehives boost flowers.': '游戏中可定期在蜂箱后种植雏菊。在主要游戏中，蜂箱可以推动花朵。',
    ...
    'Resin + twigs bonus for Transcension  II': '树脂+树枝的奖金当超越II',
    ...
    'gooseberry. Base production: 336T seeds/s. Crop type:': '醋栗。 基本产量：336T种子/秒。 作物类型：',
    ...
    'Boosting spores: 5.1e3%. Nerfing neighbor berries and flowers': '促进孢子:5.1 e3%。削弱邻居的浆果和花朵',
    'amanita. Base production: -235Qa seeds, 15B spores/s. Crop type:': '鹅膏菌。 基础产量：-235Qa种子，15B孢子/ s。 作物类型：',
    ...
    '→ Bonus for Transcension  II: 2x, so total': '→超越II的奖金：2x，所以总计',
    "Collected upcoming twigs": "收集即将到来的树枝",
    'upgrade available: "twigs extraction': '可用升级：“树枝提取',
    'Rainbow activated, flowers get a boost and aren\'t affected by winter': '彩虹被激活，花朵得到增强，并且不受冬季影响',
    'Breakdown (neighboor boost +': '击穿 (邻居提升+',
    ...
    'Replace the crop with a new one, sane as delete then plant. Shows the list of unlocked crops.': '用一个新的作物替换该作物，删除然后种植。显示未解锁的作物列表。',
