...
var cnItems = {
    ...
    "Not enough resources to plant watercress: have: 2.9101 seeds, need: 10 种子 (2s": "种植豆瓣资源不足：有：2.9101种子，需要：10种子（2s",
    ...
    "  - You still also have to use berries, mushrooms, flowers and watercress to get the necessary spores and": " - 你还必须使用浆果、蘑菇、鲜花和豆瓣菜来获得必要的孢子和",
    ...
    "Reward gotten: Unlocks the wasabi crop, which is the next tier of brassica after watercress. Once unlocked, it's available in the base game once you have grown a juniper (berry tier 9), and can be used in re-runs of this challenge as well.": "获得的奖励：解锁芥末作物，这是豆瓣菜之后的下一层芸苔属植物。 解锁后，您可以在种植杜松（浆果 9 级）后在基础游戏中使用它，并且也可以在重新运行此挑战时使用它。",
    ...
    "You can only get income from brassica, such as watercress, and their copying effect.": "您只能从芸苔属植物中获得收入，例如豆瓣菜，以及它们的复制效果。",
    ...
    "You only get income from brassica, such as watercress.": "你只能从芸苔获得收入，比如豆瓣菜。",
    "Reminder: you have to plant enough watercress before blackberry unlocks": "提醒：黑莓解锁前必须种下足够的豆瓣菜",
    "Rename": "重命名",
    ...
    "Only blackberries, champignons, anemones, nettle, bee nests, watercress and mistletoe are available, from the beginning": "从一开始就只提供黑莓、香菇、银莲花、荨麻、蜂巢、豆瓣和槲寄生",
    "Override field": "覆盖田地",
    ...
    "No crops can be deleted, except watercress": "不能删除任何作物，除了豆瓣菜",
    ...
    "Crops cannot be upgraded, except watercress": "作物不能升级，除了豆瓣菜",
