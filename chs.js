...
var cnItems = {
    ...
    "Fruit dropped: electrum apple. mushroom economy I, flower boost II, watercress copying": "掉落的水果：琥珀苹果。 蘑菇经济 I、花卉促进 II、豆瓣复制",
    ...
    "clover. Boosts neighbors. Does not boost watercress directly, but watercress gets same boosts as its neighbor resource-producing crops. Crop type: flower": "三叶草。 提升邻居。 不直接提升豆瓣菜，但豆瓣菜获得与其相邻的资源生产作物相同的提升效果。 作物类型：花卉",
    "cornflower. Boosts neighbors. Does not boost watercress directly, but watercress gets same boosts as its neighbor resource-producing crops. Crop type: flower": "矢车菊。 提升邻居。 不直接提升豆瓣菜，但豆瓣菜获得与其相邻的资源生产作物相同的提升效果。 作物类型：花卉",
    "daisy. Boosts neighbors. Does not boost watercress directly, but watercress gets same boosts as its neighbor resource-producing crops. Crop type: flower": "雏菊。 提升邻居。 不直接提升豆瓣菜，但豆瓣菜获得与其相邻的资源生产作物相同的提升效果。 作物类型：花卉",
